...
function LeftNavbar(props) {
	...
	return (
                    ...
                    <div className="left-log-name">
                        <div className="row">
                            ...
                            <div className="col-md-4">
                               <span className="sett-left float-right"><i className="fa fa-cog" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <ul className="menu">
                        ...
                        <li className="sidebar-item">
                            <a href={`${process.env.PUBLIC_URL}/documents`} className="sidebar-link">
                                <i className="fa fa-file-text" aria-hidden="true"></i>    
                                <span>Documents</span>
        ...
        {/* <header className="mb-3 active left-header"> */}
			<div onClick={() => setToggle(0)} className="burger-btn">
