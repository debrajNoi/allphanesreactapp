	...
	<>
		...
		<div className="log-box-set">
			...
			<div className="form-group mb-3 mt-2">                            
				<textarea className="form-control" id="exampleFormControlTextarea1" rows="3" name="content_long" onChange={handleChange} value={props.values.content_long || ''} disabled={(props.active > 1) ? true : false }></textarea>
