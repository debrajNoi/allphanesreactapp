			...
			<>
				{
					!iseditorOpen ?
								...
								<div className="page-content">
									<div className="form-step-sec">
										...
										<form className="form" method="post" onSubmit={handleSubmit} >
											...
											<div className="form-box-step p-4">
												{
													/*
													...
													*/
													<>
														...
														<div class="log-box-set mt-4">
															<button type="button" class="btn btn-primary btn-lg log-btn-logpage new-button" onClick={() => formStepValidate()} disabled={(active > 1) ? true : false}>Continue</button>
														</div>
														<Step2 values={values} errors={errors} onChange={handleChange} active={active} callBackStepTwo={callBackStepTwo} />
														<div class="log-box-set mt-4">
															<button type="button" class="btn btn-primary btn-lg log-btn-logpage new-button" onClick={() => formStepValidate()} disabled={(active === 2) ? false : true}>Continue</button>
														</div>
						...
						:
						<CreateProjectEditor setiseditorOpen={setiseditorOpen} values={values} selectedIdeaStepThree={selectedIdeaStepThree} titleCallback={titleCallback} keywordCallback= {keywordCallback} contentLongCallback={contentLongCallback} />
				}
